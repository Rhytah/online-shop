...
def index():
    ...
    <html>
        ...
        <div class=maincontent>
            ...
            <br>
            <a href='https://rhytahduka.herokuapp.com/creditcard/001'>Fetch specific single creditcard data</a>
            <br>
            <a href='https://rhytahduka.herokuapp.com/creditcard/001' method='PUT'>Update specific single creditcard data</a>
            <br>
            <a href='https://rhytahduka.herokuapp.com/creditcard/001' method='DELETE'>delete specific single creditcard data</a>
        </div>
        </body>
        </html>
    """
